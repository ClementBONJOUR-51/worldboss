...
export const audioConfig = {
  ...
  sounds: {
    uiToggleOn: { url: availableAudio.enterArena, category: 'ui', volume: 0.8, maxConcurrent: 1, cooldownMs: 80 },
    uiToggleOff: { url: availableAudio.returnMap, category: 'ui', volume: 0.8, maxConcurrent: 1, cooldownMs: 80 },
    modalOpen: { url: availableAudio.enterArena, category: 'ui', volume: 0.55, maxConcurrent: 2, cooldownMs: 80 },
    modalClose: { url: availableAudio.returnMap, category: 'ui', volume: 0.5, maxConcurrent: 2, cooldownMs: 80 },
    nicknameSaved: { url: availableAudio.enterArena, category: 'ui', volume: 0.62, maxConcurrent: 1, cooldownMs: 120 },
    ...
    bossClickImpact: { url: availableAudio.bossImpactLight, category: 'combat', volume: 0.2, maxConcurrent: 10, cooldownMs: 15 },
    noAmmo: { url: availableAudio.noAmmo, category: 'combat', volume: 0.7, maxConcurrent: 1, cooldownMs: 220 },
    qteReady: { url: availableAudio.bossWarningLight, category: 'combat', volume: 0.74, maxConcurrent: 1, cooldownMs: 120 },
    qteTap: { url: availableAudio.bossClickFire, category: 'combat', volume: 0.55, maxConcurrent: 2, cooldownMs: 45 },
    qteSuccess: { url: availableAudio.bossImpactUltimate, category: 'combat', volume: 0.84, maxConcurrent: 2, cooldownMs: 90 },
    qteFail: { url: availableAudio.noAmmo, category: 'combat', volume: 0.72, maxConcurrent: 2, cooldownMs: 90 },
    artilleryIncoming: { url: availableAudio.bossWarningLight, category: 'combat', volume: 0.72, maxConcurrent: 8, cooldownMs: 0 },
    artilleryImpact: { url: availableAudio.artilleryImpact, category: 'combat', volume: 0.02, maxConcurrent: 10, cooldownMs: 100 },
    structureBuild: { url: availableAudio.bossClickFire, category: 'combat', volume: 0.66, maxConcurrent: 3, cooldownMs: 70 },
    ...
    playerRecovered: { url: availableAudio.bossWarningLight, category: 'combat', volume: 0.68, maxConcurrent: 1, cooldownMs: 150 },
    bossDeath: { url: availableAudio.bossImpactUltimate, category: 'combat', volume: 0.95, maxConcurrent: 1, cooldownMs: 500 },

    emoteSelect: { url: availableAudio.chatSend, category: 'social', volume: 0.6, maxConcurrent: 3, cooldownMs: 50 },
